...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --prec-gen-fun=const_first --lazy-cnf=true --lazy-cnf-kind=simp --lazy-cnf-renaming-threshold=8\
  --tptp-def-as-rewrite --rewrite-before-cnf=true --ho-unif-level=full-framework --stream-queue-ratio=25 --stream-queue-guard=400\
  ...
  -q "4|prefer-easy-ho|conjecture-relative-var(1.01,s,f)"  --ho-solid-decider=true