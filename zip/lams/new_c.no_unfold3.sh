...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-timeout=20 --e-max-derived=40 --e-encode-lambdas=lift \
  --presaturate --prec-gen-fun=invfreq --e-call-point=0.08 --sine-trim-implications=true
