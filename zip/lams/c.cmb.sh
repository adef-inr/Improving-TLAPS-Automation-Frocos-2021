...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --select=ho-selection5 --ho-choice-inst=true --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-timeout=11 \
  --sine=50 --sine-tolerance=3 --sine-depth-max=5 --sine-depth-min=1 --e-max-derived=50 \
  --e-encode-lambdas=lift --scan-clause-ac=true --kbo-weight-fun=arity0 --prec-gen-fun=invfreq_conj --e-call-point=0.3