...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --sine=50 --sine-tolerance=1.7 --sine-depth-max=3 --sine-depth-min=1 --e-max-derived=40 \
  --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-auto=true --e-encode-lambdas=lift \
  --ord=lambda_rpo --prec-gen-fun=unary_first --e-timeout=13 --e-call-point=0.09 --sine-trim-implications=true