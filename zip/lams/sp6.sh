...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --ho-prim-enum=and --ho-prim-max=1 --ho-prim-enum-early-bird=true --trigger-bool-inst=1\
  --select=e-selection10 --prec-gen-fun=invfreq_conj --kbo-weight-fun=modarity  --ord=lambda_kbo\
  ...
  -q "1|prefer-processed|conjecture-relative-var(1,s,f)" --trigger-bool-ind=1