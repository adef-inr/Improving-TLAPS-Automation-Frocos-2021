...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --ho-prim-enum=eq --ho-prim-max=1 --ho-prim-enum-early-bird=true --trigger-bool-inst=1\
  --select=ho-selection5 --prec-gen-fun=invfreq_conj --kbo-weight-fun=modarity  --ord=lambda_kbo\
