--------------------- MODULE WellFoundedInduction_proofs_satallax --------------------
(***************************************************************************)
...
<1>4. QED 
  ...
  BY TransitiveClosureThm, TransitiveClosureWF, <1>3, WFInductiveDefLemma (* compressed: 2 steps *)
...
<1>4. QED
  (*BY <1>3*)
  BY <1>1, <1>2, NatInduction (* compressed: 1 step *)

=============================================================================
\* Modification History
\* Last modified Fri Jul 09 00:42:10 CEST 2021 by adefourn
