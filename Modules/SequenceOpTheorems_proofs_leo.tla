--------------------- MODULE SequenceOpTheorems_proofs_leo ---------------------
(**************************************************************************)
...
<1>. QED  (*BY <1>3 DEF WFInductiveDefines, TailInductiveDefConclusion*)
  BY <1>1, <1>2, SuffixRecursiveSequenceFunctionDef DEF WFInductiveDefines, TailInductiveDefConclusion (* compressed: 1 step *)
...
<1>. QED  (*BY <1>3 DEF WFInductiveDefines, FrontInductiveDefConclusion*)
  BY <1>1, <1>2, PrefixRecursiveSequenceFunctionDef DEF WFInductiveDefines, FrontInductiveDefConclusion (* compressed: 1 step *)
