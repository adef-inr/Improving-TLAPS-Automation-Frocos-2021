--------------------- MODULE FunctionTheorems_proofs_zipper ------------------------
(***************************************************************************)
(* `^{\large \vspace{12pt}                                                 *)
...
<1>6. \A i \in Nat : Ci[i] \subseteq S
  ...
  (*<2> HIDE DEF Prop*)
  <2> QED BY <2>1, <2>2, NatInduction (* compressed: 1 step *)
...
<1>1. PICK m \in Nat :
  ...
  <2>. QED
    BY <2>1 DEF OpToRel*)
  BY WFMin, NatLessThanWellFounded DEF OpToRel (* compressed: 1 step *)
...
\* Last modified Thu Jul 08 18:19:59 CEST 2021 by adefourn
