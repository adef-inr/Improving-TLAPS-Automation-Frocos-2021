...
theory tlapm_42b7e4 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_vampire.tla", line 688, characters 12-13 *)
lemma ob'20: (* 39f508fb20bc5a6aed5afd581854fe5e *)
...
shows "(((IsFiniteSet ((((S) \<union> (T)))))) & ((((Cardinality ((((S) \<union> (T)))))) = ((arith_add (((Cardinality ((S)))), ((arith_add (((Cardinality ((T)))), ((minus (((Cardinality ((((S) \<inter> (T))))))))))))))))))"(is "PROP ?ob'20")
proof -
show "PROP ?ob'20"
using assms by auto
qed
