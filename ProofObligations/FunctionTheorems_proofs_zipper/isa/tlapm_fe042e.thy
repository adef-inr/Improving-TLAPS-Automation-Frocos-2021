...
theory tlapm_fe042e imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FunctionTheorems_proofs_zipper.tla", line 519, characters 11-12 *)
lemma ob'3: (* b01dcab67136d8853e9c70899fcd994e *)
...
shows "(\<forall> i \<in> (Nat) : (((fapply ((Ci), (i))) \<subseteq> (S))))"(is "PROP ?ob'3")
proof -
show "PROP ?ob'3"
using assms by auto
qed
