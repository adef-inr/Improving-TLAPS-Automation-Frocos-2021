...
thf(fact28, axiom, ( thf__TLA__Mem @ thf__TLA__IntLit_0 @ thf__TLA__IntSet )).

thf(fact29, axiom,
  ( thf__TLA__Lteq @ thf__TLA__IntLit_0 @ thf__TLA__IntLit_0 )).

thf(fact30, axiom, ( thf__TLA__IntLit_1 != thf__TLA__IntLit_0 )).

thf(fact31, axiom, ( thf__TLA__Mem @ thf__TLA__IntLit_2 @ thf__TLA__IntSet )).

thf(fact32, axiom,
  ( thf__TLA__Lteq @ thf__TLA__IntLit_0 @ thf__TLA__IntLit_2 )).

thf(fact33, axiom, ( thf__TLA__IntLit_1 != thf__TLA__IntLit_2 )).

thf(fact34, axiom, ( thf__TLA__IntLit_0 != thf__TLA__IntLit_2 )).
      ...
      ( ( thf__TLA__Mem @ THF__x @ thf__S ) =>
        ( ( ! [ THF__y: $i ] :
            ( ( thf__TLA__Mem @ THF__y @
              ...
              ( ( thf__TLA__FunApp @ THF__g @ THF__y ) =
                ( thf__TLA__FunApp @ THF__h @ THF__y ) ) ) ) =>
          ( ( thf__Def @ THF__g @ THF__x ) = ( thf__Def @ THF__h @ THF__x ) ) ) ) ) )).
              ...
              ( ( ! [ THF__y: $i ] :
                  ( ( thf__TLA__Mem @ THF__y @
                      ( thf__TLA__SetSt @ THF__S @
                        ( ^ [ THF__y_1: $i ] :
                          ( thf__TLA__Mem @
                            ( thf__TLA__Tuple_2 @ THF__y_1 @ THF__x ) @
                            THF__R ) ) ) ) =>
                    ( ( thf__TLA__FunApp @ THF__g @ THF__y ) =
                      ( thf__TLA__FunApp @ THF__h @ THF__y ) ) ) ) =>
                ( ( THF__Def @ THF__g @ THF__x ) =
                  ( THF__Def @ THF__h @ THF__x ) ) ) ) ) ) &
