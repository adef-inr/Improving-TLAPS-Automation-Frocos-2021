...
theory tlapm_1aec75 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_cvc4.tla", line 899, characters 12-13 *)
lemma ob'26: (* 678d231ffd118f8fdffe770831a08ecc *)
...
shows "(((IsFiniteSet (((SUBSET (S)))))) & ((((Cardinality (((SUBSET (S)))))) = ((isa_care_a (((Succ[Succ[0]])), ((Cardinality ((S))))))))))"(is "PROP ?ob'26")
proof -
show "PROP ?ob'26"
using assms by auto
qed
