...
theory tlapm_c5fac4 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_cvc4.tla", line 788, characters 12-13 *)
lemma ob'18: (* fc85f2482a866acb188f0ca62229dd93 *)
...
shows "(((\<forall> T \<in> (S) : ((IsFiniteSet ((T))))) \<Rightarrow> ((IsFiniteSet (((UNION (S))))))))"(is "PROP ?ob'18")
proof -
show "PROP ?ob'18"
using assms by auto
qed
