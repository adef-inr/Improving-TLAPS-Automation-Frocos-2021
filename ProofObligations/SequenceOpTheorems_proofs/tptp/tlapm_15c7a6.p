...
thf(fresh_thf__TLA__Append, type, ( thf__TLA__Append: $i > $i > $i )).
...
thf(defn_thf__FrontInductiveDefHypothesis, type,
  ( thf__FrontInductiveDefHypothesis: $i > $i > $i > ( $i > $i > $i ) > $i )).

thf(defn_thf__FrontInductiveDefConclusion, type,
  ( thf__FrontInductiveDefConclusion: $i > $i > $i > ( $i > $i > $i ) > $i )).
...
thf(fact205, axiom,
  ( ( thf__FrontInductiveDefConclusion @ thf__f @ thf__S @ thf__f0 @ thf__Def ) =
    thf__TLA__Tt_Idv )).

thf(fact206, axiom, ( thf__TLA__Mem @ thf__f0 @ thf__T )).
        ...
        ( ( ( thf__TLA__Mem @ THF__e @ thf__S ) &
            ...
            ( thf__TLA__Mem @
              ( thf__TLA__FunApp @ thf__f @
                ( thf__TLA__Append @ THF__seq @ THF__e ) ) @ thf__T ) ) ) )).
        ...
        ( ! [ THF__s: $i, THF__e: $i ] :
          ( ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ THF__S ) ) &
            ...
            ( ( ( THF__P @ THF__s ) = thf__TLA__Tt_Idv ) =>
              ( ( THF__P @ ( thf__TLA__Append @ THF__s @ THF__e ) ) =
                thf__TLA__Tt_Idv ) ) ) ) )  =>
        ( ! [ THF__seq: $i ] :
          ( ( thf__TLA__Mem @ THF__seq @ ( thf__TLA__Seq @ THF__S ) ) =>
