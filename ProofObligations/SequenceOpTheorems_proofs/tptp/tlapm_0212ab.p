...
thf(fact181, axiom,
  ( ! [ THF__S: $i, THF__Def: $i > $i > $i ] :
    ( ( ( ( thf__StrictSuffixesDetermineDef @ THF__S @ THF__Def ) =
          thf__TLA__Tt_Idv ) )  =>
        ( ( thf__WFDefOn @
            ( thf__OpToRel @ thf__IsStrictSuffix @ ( thf__TLA__Seq @ THF__S ) ) @
...
thf(fact183, axiom,
  ( ! [ THF__Def: $i > $i > $i, THF__R: $i, THF__S: $i ] :
    ( ( ( ( thf__IsWellFoundedOn @ THF__R @ THF__S ) = thf__TLA__Tt_Idv ) &
        ( ( thf__WFDefOn @ THF__R @ THF__S @ THF__Def ) = thf__TLA__Tt_Idv ) )  =>
        ( ( thf__WFInductiveUnique @ THF__S @ THF__Def ) = thf__TLA__Tt_Idv ) ) )).

%---- Goal
thf(goal, conjecture,
  ( ( thf__WFInductiveUnique @ ( thf__TLA__Seq @ thf__S ) @ thf__Def ) =
    thf__TLA__Tt_Idv )).
