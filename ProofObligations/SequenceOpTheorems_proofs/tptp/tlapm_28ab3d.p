...
thf(fact158, axiom, ( ( thf__P @ thf__TLA__Tuple_0 ) = thf__TLA__Tt_Idv )).

thf(fact159, axiom,
  ( ! [ THF__s: $i ] :
    ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ thf__S ) ) =>
      ( ( ( THF__s != thf__TLA__Tuple_0 ) &
          ( ( thf__P @ ( thf__Front @ THF__s ) ) = thf__TLA__Tt_Idv ) ) =>
...
thf(fact164, axiom,
  ( ! [ THF__s: $i ] :
    ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ thf__S ) ) =>
      ( ( ( thf__TLA__Len @ THF__s ) = thf__TLA__IntLit_0 ) =>
        ( ( thf__P @ THF__s ) = thf__TLA__Tt_Idv ) ) ) )).
...
thf(fact165, axiom,
  ( ! [ THF__n: $i ] :
    ( ( ( thf__TLA__Mem @ THF__n @ thf__TLA__NatSet ) &
        ( ! [ THF__s: $i ] :
          ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ thf__S ) ) =>
            ( ( ( thf__TLA__Len @ THF__s ) = THF__n ) =>
              ( ( thf__P @ THF__s ) = thf__TLA__Tt_Idv ) ) ) ) )  =>
        ( ! [ THF__s: $i ] :
          ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ thf__S ) ) =>
            ( ( ( thf__TLA__Len @ THF__s ) =
