...
theory tlapm_eec6e0 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/SequenceOpTheorems_proofs.tla", line 729, characters 3-4 *)
lemma ob'31: (* 2e12b73f4e2a69ef60ddcb367b83570a *)
...
assumes v'183: "((IsWellFoundedOn (((OpToRel ((IsStrictPrefix), ((Seq ((S))))))), ((Seq ((S)))))))"
assumes v'184: "((WFDefOn (((OpToRel ((IsStrictPrefix), ((Seq ((S))))))), ((Seq ((S)))), (Def))))"
...
shows "(((f) \<in> ([((Seq ((S)))) \<rightarrow> (T)])))"(is "PROP ?ob'31")
proof -
show "PROP ?ob'31"
using assms by auto
qed
