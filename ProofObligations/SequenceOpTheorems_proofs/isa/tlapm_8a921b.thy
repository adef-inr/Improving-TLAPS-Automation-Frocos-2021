...
theory tlapm_8a921b imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/SequenceOpTheorems_proofs.tla", line 708, characters 1-2 *)
lemma ob'23: (* 56cccd9c8394a325891fe4fbf884be47 *)
...
fixes S
fixes Def
assumes v'173: "((StrictPrefixesDetermineDef ((S), (Def))))"
assumes v'174: "((\<And> S_1 :: c. (\<And> Def_1 :: c => c => c. (((StrictPrefixesDetermineDef ((S_1), (Def_1)))) \<Longrightarrow> ((WFDefOn (((OpToRel ((IsStrictPrefix), ((Seq ((S_1))))))), ((Seq ((S_1)))), (Def_1))))))))"
assumes v'175: "((\<And> S_1 :: c. ((IsWellFoundedOn (((OpToRel ((IsStrictPrefix), ((Seq ((S_1))))))), ((Seq ((S_1)))))))))"
assumes v'176: "((\<And> Def_1 :: c => c => c. (\<And> R :: c. (\<And> S_1 :: c. (((IsWellFoundedOn ((R), (S_1)))) \<Longrightarrow> (((WFDefOn ((R), (S_1), (Def_1)))) \<Longrightarrow> ((WFInductiveUnique ((S_1), (Def_1))))))))))"
shows "((WFInductiveUnique (((Seq ((S)))), (Def))))"(is "PROP ?ob'23")
proof -
show "PROP ?ob'23"
using assms by auto
qed
