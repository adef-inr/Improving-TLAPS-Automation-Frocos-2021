...
theory tlapm_362592 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/SequenceOpTheorems_proofs.tla", line 744, characters 1-2 *)
lemma ob'37: (* 56cccd9c8394a325891fe4fbf884be47 *)
...
fixes S
fixes Def
assumes v'178: "((StrictSuffixesDetermineDef ((S), (Def))))"
assumes v'179: "((\<And> S_1 :: c. (\<And> Def_1 :: c => c => c. (((StrictSuffixesDetermineDef ((S_1), (Def_1)))) \<Longrightarrow> ((WFDefOn (((OpToRel ((IsStrictSuffix), ((Seq ((S_1))))))), ((Seq ((S_1)))), (Def_1))))))))"
assumes v'180: "((\<And> S_1 :: c. ((IsWellFoundedOn (((OpToRel ((IsStrictSuffix), ((Seq ((S_1))))))), ((Seq ((S_1)))))))))"
assumes v'181: "((\<And> Def_1 :: c => c => c. (\<And> R :: c. (\<And> S_1 :: c. (((IsWellFoundedOn ((R), (S_1)))) \<Longrightarrow> (((WFDefOn ((R), (S_1), (Def_1)))) \<Longrightarrow> ((WFInductiveUnique ((S_1), (Def_1))))))))))"
shows "((WFInductiveUnique (((Seq ((S)))), (Def))))"(is "PROP ?ob'37")
proof -
show "PROP ?ob'37"
using assms by auto
qed
