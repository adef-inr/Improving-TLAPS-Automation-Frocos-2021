...
theory tlapm_e320ac imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/SequenceOpTheorems_proofs.tla", line 751, characters 1-2 *)
lemma ob'41: (* 32ef246d26b4a5bc6c49aedd2b91b847 *)
...
fixes Def
fixes f
assumes v'180: "((StrictSuffixesDetermineDef ((S), (Def))))"
assumes v'181: "((OpDefinesFcn ((f), ((Seq ((S)))), (Def))))"
assumes v'182: "((\<And> S_1 :: c. (\<And> Def_1 :: c => c => c. (((StrictSuffixesDetermineDef ((S_1), (Def_1)))) \<Longrightarrow> ((WFDefOn (((OpToRel ((IsStrictSuffix), ((Seq ((S_1))))))), ((Seq ((S_1)))), (Def_1))))))))"
assumes v'183: "((\<And> S_1 :: c. ((IsWellFoundedOn (((OpToRel ((IsStrictSuffix), ((Seq ((S_1))))))), ((Seq ((S_1)))))))))"
assumes v'184: "((\<And> Def_1 :: c => c => c. (\<And> R :: c. (\<And> S_1 :: c. (\<And> f_1 :: c. (((IsWellFoundedOn ((R), (S_1)))) \<Longrightarrow> (((WFDefOn ((R), (S_1), (Def_1)))) \<Longrightarrow> (((OpDefinesFcn ((f_1), (S_1), (Def_1)))) \<Longrightarrow> ((WFInductiveDefines ((f_1), (S_1), (Def_1))))))))))))"
shows "((WFInductiveDefines ((f), ((Seq ((S)))), (Def))))"(is "PROP ?ob'41")
proof -
show "PROP ?ob'41"
using assms by auto
qed
