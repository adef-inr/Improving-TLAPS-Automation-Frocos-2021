...
theory tlapm_792be8 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_satallax.tla", line 900, characters 12-13 *)
lemma ob'32: (* 678d231ffd118f8fdffe770831a08ecc *)
...
shows "(((IsFiniteSet (((SUBSET (S)))))) & ((((Cardinality (((SUBSET (S)))))) = ((isa_care_a (((Succ[Succ[0]])), ((Cardinality ((S))))))))))"(is "PROP ?ob'32")
proof -
show "PROP ?ob'32"
using assms by auto
qed
