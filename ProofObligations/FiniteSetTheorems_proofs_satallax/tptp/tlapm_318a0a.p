...
%---- Proof obligation #5
%---- Generated from file "./Modules/FiniteSetTheorems_proofs_satallax.tla", line 200, characters 15-16
  ...
  ( ! [ THF__T: $i ] :
    ( ( thf__TLA__Mem @ THF__T @ ( thf__TLA__Subset @ thf__S ) ) =>
      ( ( ( thf__ExistsBijection @
        ...
        ( ( thf__TLA__FunApp @ thf__CS1 @ THF__T ) =
          ( thf__TLA__FunApp @ thf__CS2 @ THF__T ) ) ) ) )).
