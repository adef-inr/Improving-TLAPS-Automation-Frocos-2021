...
theory tlapm_0e4361 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs.tla", line 898, characters 12-13 *)
lemma ob'33: (* 3c79a6e2eb2e64d0658fbec9de917d27 *)
...
assumes v'151: "((P (({}))))"
assumes v'152: "((\<And> A :: c. (\<And> x :: c. (((IsFiniteSet ((A)))) \<Longrightarrow> ((((x) \<notin> (A))) \<Longrightarrow> (((P ((A)))) \<Longrightarrow> ((P ((((A) \<union> ({(x)}))))))))))))"
assumes v'153: "((\<And> S_1 :: c. (((IsFiniteSet ((S_1)))) \<Longrightarrow> (\<And> P_1 :: c => c. (((P_1 (({})))) \<Longrightarrow> (((\<And> T :: c. (\<And> x :: c. (((IsFiniteSet ((T)))) \<Longrightarrow> (((P_1 ((T)))) \<Longrightarrow> ((((x) \<notin> (T))) \<Longrightarrow> ((P_1 ((((T) \<union> ({(x)})))))))))))) \<Longrightarrow> ((P_1 ((S_1))))))))))"
shows "((P ((S))))"(is "PROP ?ob'33")
proof -
show "PROP ?ob'33"
using assms by auto
qed
