...
theory tlapm_5984d0 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs.tla", line 686, characters 12-13 *)
lemma ob'21: (* 67261ddffc645c1fc35566a9be3bb1f6 *)
...
assumes v'147: "((P (({}))))"
assumes v'148: "((\<And> A :: c. (\<And> x :: c. (((IsFiniteSet ((A)))) \<Longrightarrow> (((P ((A)))) \<Longrightarrow> ((((x) \<notin> (A))) \<Longrightarrow> ((P ((((A) \<union> ({(x)}))))))))))))"
assumes v'149: "((\<And> S_1 :: c. (((IsFiniteSet ((S_1)))) \<Longrightarrow> (\<And> P_1 :: c => c. (((P_1 (({})))) \<Longrightarrow> (((\<And> T_1 :: c. (\<And> x :: c. (((IsFiniteSet ((T_1)))) \<Longrightarrow> (((P_1 ((T_1)))) \<Longrightarrow> ((((x) \<notin> (T_1))) \<Longrightarrow> ((P_1 ((((T_1) \<union> ({(x)})))))))))))) \<Longrightarrow> ((P_1 ((S_1))))))))))"
shows "((P ((T))))"(is "PROP ?ob'21")
proof -
show "PROP ?ob'21"
using assms by auto
qed
