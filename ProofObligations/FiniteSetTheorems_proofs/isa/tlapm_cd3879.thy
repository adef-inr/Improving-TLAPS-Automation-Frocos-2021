...
theory tlapm_cd3879 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs.tla", line 148, characters 15-16 *)
lemma ob'1: (* 0ab9c9e1fcf59bdca90f372c82ee7f4f *)
...
assumes v'128: "((Prop (((0)))))"
assumes v'129: "((\<And> i :: c. i \<in> (Nat) \<Longrightarrow> (((Prop ((i)))) \<Longrightarrow> ((Prop (((arith_add ((i), ((Succ[0])))))))))))"
assumes v'130: "((\<And> P :: c => c. (((P (((0))))) \<Longrightarrow> ((\<forall> n_1 \<in> (Nat) : ((((P ((n_1)))) \<Rightarrow> ((P (((arith_add ((n_1), ((Succ[0]))))))))))) \<Longrightarrow> (\<forall> n_1 \<in> (Nat) : ((P ((n_1)))))))))"
shows "(\<forall> i \<in> (Nat) : ((Prop ((i)))))"(is "PROP ?ob'1")
proof -
show "PROP ?ob'1"
using assms by auto
qed
