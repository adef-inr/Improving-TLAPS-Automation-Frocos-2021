...
theory tlapm_eccf5d imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/WellFoundedInduction_proofs.tla", line 321, characters 1-13 *)
lemma ob'6: (* a164e4a839a5f6a521d12fc547dbf2cf *)
...
shows "(\<forall>R : (\<forall>S : ((((((R) \<inter> (((S) \<times> (S))))) \<subseteq> ((TransitiveClosureOn ((R), (S)))))) & ((IsTransitivelyClosedOn (((TransitiveClosureOn ((R), (S)))), (S)))))))"(is "PROP ?ob'6")
proof -
show "PROP ?ob'6"
using assms by auto
qed
