          ...
          ( thf__TLA__FunFcn @ ( thf__TLA__Seq @ thf__S ) @
            ( ^ [ THF__s: $i ] :
              ( $ite(( THF__s = thf__TLA__Tuple_0 ), thf__f0,
                  ( thf__Def @
                    ( thf__TLA__FunApp @ THF__g @ ( thf__TLA__Tail @ THF__s ) ) @
                    THF__s )) ) ) ) ) ) ) )).
...
thf(fact198, axiom,
  ( ! [ THF__S: $i, THF__s: $i ] :
    ( ( ( thf__TLA__Mem @ THF__s @ ( thf__TLA__Seq @ THF__S ) ) &
        ...
        ( ( thf__IsStrictSuffix @ ( thf__TLA__Tail @ THF__s ) @ THF__s ) =
          thf__TLA__Tt_Idv ) ) )).
  ...
  ( ! [ THF__S: $i, THF__Def: $i > $i > $i, THF__f: $i ] :
    ( ( ( ! [ THF__g: $i, THF__h: $i ] :
          ( ! [ THF__seq: $i ] :
            ( ( thf__TLA__Mem @ THF__seq @ ( thf__TLA__Seq @ THF__S ) ) =>
              ( ( ! [ THF__suf: $i ] :
                  ( ( thf__TLA__Mem @ THF__suf @ ( thf__TLA__Seq @ THF__S ) ) =>
                    ( ( ( thf__IsStrictSuffix @ THF__suf @ THF__seq ) =
                        thf__TLA__Tt_Idv ) =>
                      ( ( thf__TLA__FunApp @ THF__g @ THF__suf ) =
                        ( thf__TLA__FunApp @ THF__h @ THF__suf ) ) ) ) ) =>
