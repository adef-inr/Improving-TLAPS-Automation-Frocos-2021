...
%---- Proof obligation #1
%---- Generated from file "./Modules/FunctionTheorems_proofs_leo.tla", line 481, characters 5-6
...
thf(fact21, axiom, ( thf__TLA__Mem @ thf__TLA__IntLit_0 @ thf__TLA__IntSet )).
...
thf(fact125, axiom, ( thf__TLA__SubsetEq @ thf__T @ thf__S )).
  ...
  ( ! [ THF__Def: $i > $i > $i, THF__f: $i, THF__f0: $i ] :
    ( ( ( THF__f =
          ( thf__TLA__Choose @
            ( ^ [ THF__g: $i ] :
              ( THF__g =
                ( thf__TLA__FunFcn @ thf__TLA__NatSet @
                  ( ^ [ THF__i: $i ] :
                    ( $ite(( THF__i = thf__TLA__IntLit_0 ), THF__f0,
                        ( THF__Def @
                          ( thf__TLA__FunApp @ THF__g @
                            ( thf__TLA__Minus @ THF__i @ thf__TLA__IntLit_1 ) ) @
                          THF__i )) ) ) ) ) ) ) ) )  =>
        ( THF__f =
          ( thf__TLA__FunFcn @ thf__TLA__NatSet @
            ( ^ [ THF__i: $i ] :
          ...
          ( thf__TLA__Choose @
            ( ^ [ THF__f: $i ] :
              ( THF__f =
                ( thf__TLA__FunFcn @ thf__TLA__NatSet @
                  ( ^ [ THF__i_1: $i ] :
                    ( $ite(( THF__i_1 = thf__TLA__IntLit_0 ), thf__f0,
                        ( thf__Def @
                          ( thf__TLA__FunApp @ THF__f @
                            ( thf__TLA__Minus @ THF__i_1 @ thf__TLA__IntLit_1 ) ) @
                          THF__i_1 )) ) ) ) ) ) ) @ THF__i ) =
        ( $ite(( THF__i = thf__TLA__IntLit_0 ), thf__f0,
            ( thf__Def @
              ( thf__TLA__FunApp @
                      ...
                      ( thf__TLA__FunFcn @ thf__TLA__NatSet @
                        ( ^ [ THF__i_1: $i ] :
                          ( $ite(( THF__i_1 = thf__TLA__IntLit_0 ), thf__f0,
                              ( thf__Def @
                                ( thf__TLA__FunApp @ THF__f @
                                  ( thf__TLA__Minus @ THF__i_1 @
                                    thf__TLA__IntLit_1 ) ) @ THF__i_1 )) ) ) ) ) ) ) @
                ( thf__TLA__Minus @ THF__i @ thf__TLA__IntLit_1 ) ) @ THF__i )) ) ) ) )).
