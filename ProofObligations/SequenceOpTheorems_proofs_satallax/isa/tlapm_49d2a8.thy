...
theory tlapm_49d2a8 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/SequenceOpTheorems_proofs_satallax.tla", line 767, characters 3-4 *)
lemma ob'5: (* 56db3dc2e4055ad129c71fe09960a2ec *)
...
shows "(((f) \<in> ([((Seq ((S)))) \<rightarrow> (T)])))"(is "PROP ?ob'5")
proof -
show "PROP ?ob'5"
using assms by auto
qed
