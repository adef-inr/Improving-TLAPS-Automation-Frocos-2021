...
theory tlapm_ee050d imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
lemma ob'23: (* 39f508fb20bc5a6aed5afd581854fe5e *)
...
shows "(((IsFiniteSet ((((S) \<union> (T)))))) & ((((Cardinality ((((S) \<union> (T)))))) = ((arith_add (((Cardinality ((S)))), ((arith_add (((Cardinality ((T)))), ((minus (((Cardinality ((((S) \<inter> (T))))))))))))))))))"(is "PROP ?ob'23")
proof -
show "PROP ?ob'23"
using assms by auto
qed
