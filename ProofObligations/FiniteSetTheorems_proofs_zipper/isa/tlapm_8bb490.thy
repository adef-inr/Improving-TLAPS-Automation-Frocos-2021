...
theory tlapm_8bb490 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_zipper.tla", line 843, characters 12-13 *)
lemma ob'31: (* f2b1afab027161bcee9ed1107a7e08cc *)
...
shows "(((IsFiniteSet ((((S) \<times> (T)))))) & ((((Cardinality ((((S) \<times> (T)))))) = ((mult (((Cardinality ((S)))), ((Cardinality ((T))))))))))"(is "PROP ?ob'31")
proof -
show "PROP ?ob'31"
using assms by auto
qed
