...
theory tlapm_9efde0 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
(* Generated from file "./Modules/FiniteSetTheorems_proofs_zipper.tla", line 789, characters 12-13 *)
lemma ob'27: (* fc85f2482a866acb188f0ca62229dd93 *)
...
shows "(((\<forall> T \<in> (S) : ((IsFiniteSet ((T))))) \<Rightarrow> ((IsFiniteSet (((UNION (S))))))))"(is "PROP ?ob'27")
proof -
show "PROP ?ob'27"
using assms by auto
qed
