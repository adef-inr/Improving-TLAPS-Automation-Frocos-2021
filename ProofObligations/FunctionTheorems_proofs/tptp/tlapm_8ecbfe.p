...
thf(fact39, axiom, ( thf__TLA__Mem @ thf__TLA__IntLit_2 @ thf__TLA__IntSet )).

thf(fact40, axiom,
  ( thf__TLA__Lteq @ thf__TLA__IntLit_0 @ thf__TLA__IntLit_2 )).

thf(fact41, axiom, ( thf__TLA__IntLit_1 != thf__TLA__IntLit_2 )).

thf(fact42, axiom, ( thf__TLA__IntLit_0 != thf__TLA__IntLit_2 )).
...
thf(fact150, axiom, ( thf__TLA__Mem @ thf__n @ thf__TLA__NatSet )).
...
thf(goal, conjecture,
  ( ? [ THF__m: $i ] :
    ( ( thf__TLA__Mem @ THF__m @
        ( thf__TLA__SetSt @ thf__TLA__NatSet @
          ( ^ [ THF__m_1: $i ] :
            ( ( thf__ExistsSurjection @
                ( thf__TLA__Range @ thf__TLA__IntLit_1 @ THF__m_1 ) @ thf__S ) =
              thf__TLA__Tt_Idv ) ) ) ) &
      ( ! [ THF__k: $i ] :
        ( ( thf__TLA__Mem @ THF__k @
            ( thf__TLA__SetSt @ thf__TLA__NatSet @
              ( ^ [ THF__m_1: $i ] :
                ( ( thf__ExistsSurjection @
                    ( thf__TLA__Range @ thf__TLA__IntLit_1 @ THF__m_1 ) @
                    thf__S ) = thf__TLA__Tt_Idv ) ) ) ) =>
          ( ~ ( thf__TLA__Mem @ ( thf__TLA__Tuple_2 @ THF__k @ THF__m ) @
                ( thf__OpToRel @
                  ( ^ [ THF__x1: $i, THF__x2: $i ] :
                    ( thf__TLA__Cast_Bool @
